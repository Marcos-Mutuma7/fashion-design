...
import BannerBG from 'assets/images/banner-bg-1-1.png';
import BannerTextLine from 'assets/images/banner-text-line.png';
import BannerPattern from 'assets/images/banner-pattern.png';
import BannerImage from 'assets/images/banner-image-1.png';
import PartnerImage from 'assets/images/brands.svg';
          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              ...
              <Box as="form" sx={styles.banner.form}>
                <Box aInstalls="label" htmlFor="search" variant="styles.srOnly">
                  Search
                </Box>
                <Input
                  name="search"
